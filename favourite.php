...
<html lang="en">
    ...
    <head>
        ...
        <title>PizzaWeb - Favourite</title>
        ...
        <div class="menusDiv">
                ...
                <div class="indivaluItem">
                    <div class="individualImage"
                        ...
                        ?>'><span></span> </div>
                        <a href="favdelete.php?id=<?php echo $data['itemid'];?>" style="color:white;">
                        <i class="fas fa-heart hrt fa-2x"></i></a>
                    ...
                    <div class=" individualFeature">
                        ...
                        <a href="addcart.php?id=<?php echo $data['itemid'];?>&email=<?php echo $_SESSION['username'];?>">ADD TO CART</a>
                    </div>
                </div>
